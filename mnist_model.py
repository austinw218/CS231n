...
if __name__ == '__main__':
    ...
    data_train = torchvision.datasets.MNIST('data/', train=True, transform=transforms.ToTensor())
    trainset_loader = DataLoader(data_train, batch_size=100, shuffle=True, num_workers=1)

    data_test = torchvision.datasets.MNIST('data/', train=False, transform=transforms.ToTensor())
