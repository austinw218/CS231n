...
if __name__ == "__main__":
    ...
    # Data loader
    loader = utils.get_adv_data('cifar_eps_5e-3', batch_size=batch_size)
    ...
    for epoch in range(num_epochs):
        ...
        for i, (orig, _, adv, _, _) in enumerate(loader):
    ...
    save_checkpoint('cifar_autoencoder_model_adv',auto,optimizer)
